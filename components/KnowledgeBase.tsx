            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        ...
                        <div key={input.id}>
                            ...
                            <div className="relative">
                                <input 
                                    ...
                                    className="w-full pl-4 pr-4 py-2.5 bg-white border border-slate-200 rounded-xl text-sm font-bold text-slate-800 focus:ring-2 focus:ring-blue-500 focus:outline-none transition-all"
                                />
                                {input.unit && <span className="absolute right-4 top-1/2 -translate-y-1/2 text-slate-400 text-xs font-bold">{input.unit}</span>}
                            </div>
                        </div>
                    ))}
                ...
                <div className="flex flex-col justify-center items-center bg-white rounded-xl border border-blue-100 p-6 shadow-sm">
                    ...
                    <div className="text-4xl font-black text-blue-600">
                        ...
                        {!config.isCurrency && config.resultUnit && <span className="text-xl ml-1 text-slate-400">{config.resultUnit}</span>}
                    </div>
                </div>
            </div>
        </div>
...
const KnowledgeBase: React.FC = () => {
  ...
  return (
    <div className="p-6 md:p-12 max-w-7xl mx-auto min-h-screen relative">
      
      {/* Header */}
      <div className="mb-10">
        <h1 className="text-3xl font-bold text-slate-900 mb-4">Knowledge Base</h1>
        ...
        <div className="relative max-w-2xl">
            ...
            <input 
                ...
                className="w-full pl-12 pr-4 py-4 bg-white border border-slate-200 rounded-2xl shadow-sm text-slate-700 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-100 focus:border-blue-500 transition-all text-lg"
            />
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
        {filteredItems.map((item) => (
            <div 
                ...
                className="bg-white rounded-2xl border border-slate-100 p-6 shadow-sm hover:shadow-md hover:border-blue-200 hover:-translate-y-1 transition-all group flex flex-col h-full cursor-pointer relative"
            >
          ...
          <div className="fixed inset-0 z-50 flex justify-end">
              ...
              <div className="relative w-full max-w-2xl bg-white shadow-2xl h-full overflow-y-auto animate-in slide-in-from-right duration-300">
                  ...
                  <div className="p-8 md:p-12">
                      ...
                      <h2 className="text-3xl font-extrabold text-slate-900 mt-4 mb-2">{selectedItem.term}</h2>
                      <p className="text-lg text-slate-600 font-medium leading-relaxed border-l-4 border-blue-500 pl-4 bg-blue-50/50 py-2 rounded-r-lg">
                      ...
                      <div className="mt-8 space-y-8">
                          ...
                          {selectedItem.formula && (
                              <div>
                                  ...
                                  <div className="bg-slate-900 text-white p-4 rounded-xl font-mono text-sm shadow-lg">
                                      {selectedItem.formula}
                                  </div>
                              </div>
                          )}
